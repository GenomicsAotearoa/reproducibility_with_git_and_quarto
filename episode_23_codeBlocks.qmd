...
There are also keyboard shortcuts: `shift`{style="color:black"} + `command`{style="color:black"} + `I`{style="color:black"} for mac, or `windows`{style="color:black"} + `alt`{style="color:black"} + `I`{style="color:black"} for a Windows machine. 
