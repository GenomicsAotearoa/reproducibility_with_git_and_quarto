...
We need a few packages for this episode. If you need to install these, you can do it now if you wish with the following code:
...
Create a new quarto document `(File > New File > Quarto Document)`{style="color:black"}, give it the title "Code in Quarto" and select `Create Empty Document`{style="color:black"}
