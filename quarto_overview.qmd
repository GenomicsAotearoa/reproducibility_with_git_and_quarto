...
- Practice practice practice! Theme, styles (chatgpt), 

    - For styles, exercise where I'll demonstrate using chatgpt for a prompt that creates a basic styles.css, and challenge others to use chatgpt to get something that looks very different. 
