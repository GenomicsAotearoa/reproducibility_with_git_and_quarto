...
<footer class="navigation-buttons">
  <a href="episode_02_SettingUpGit.qmd">
    <button class="nav-button prev-button">Previous: Setting Up Git</button>
  </a>
  <a href="episode_04_TrackingChanges.qmd">
    <button class="nav-button next-button">Next: Tracking, adding and committing changes</button>
  </a>
</footer>