...
If SSH has been set up on the computer you’re using, the public and private key pairs will be listed. The file names are either `id_ed25519`{style="color:blue"}/`id_ed25519.pub`{style="color:blue"} or `id_rsa`{style="color:blue"}/`id_rsa.pub`{style="color:blue"} depending on how the key pairs were set up.  
...
**You may want to be extra-safe and check the ssh key matches one of [GitHub's known public ssh keys.](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/githubs-ssh-key-fingerprints)** 
...
If you set a passphrase, you'll get asked for that now:
...
Now go to your github and have a look - your new recipe repository with the `guacamole.qmd`{style="color:blue"} file should be online!
