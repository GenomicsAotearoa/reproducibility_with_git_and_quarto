...
Save your Quarto file (`CTRL`{style="color:black"} + `S`{style="color:black"} or `CMD`{style="color:black"} + `S`{style="color:black"}), give it a name if you have not already (*e.g.,* `test-file.qmd`{style="color:blue"}) and save it into the directory you made earlier (mine is called `my-test-repo`{style="color:blue"}).
