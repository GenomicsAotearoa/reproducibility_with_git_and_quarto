...
4. Click render from one of the existing .qmd files. You cannot render from the _quarto.yml file itself! Alternatively, type `quarto preview` in the terminal.
