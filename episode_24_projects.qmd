...
├── index.qmd                # Project overview, landing page 

├── about.qmd               # Team/project info

├── README.md           # Specific project readme, recommended when using GitHub.    
...
└── docs/                    # Exported PDFs, HTMLs, or other formats
...
#### **EXERCISE 🧠🏋️‍♀️:** Create your own _quarto.yml, add themes and options (5 min)
