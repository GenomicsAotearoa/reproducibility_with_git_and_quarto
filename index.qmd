...
* Forking, resbasing, advanced merge strategies.  
...
See [Part One - Git: Setup on local machine](git_overview.qmd#setup-on-local-machine) for setup instructions. Quarto is a part of RStudio, therefore you will not need to setup anything extra for Part Two - Quarto. Optionally you can download and install the [Quarto CLI](https://quarto.org/docs/get-started/), which will allow you to render quarto documents without RStudio.
